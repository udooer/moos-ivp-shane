...
nsplug meta_vehicle.moos targ_$VNAME1.moos -f WARP=$TIME_WARP  \
   ...
   CONCURRENT=$CONCURRENT  ADAPTIVE=$ADAPTIVE SHORE_IP=$SHORE_IP SIM=$SIM

nsplug meta_vehicle.bhv targ_$VNAME1.bhv -f VNAME=$VNAME1      \
    START_POS=$START_POS1 SURVEY_X=$SURVEY_X SURVEY_Y=$SURVEY_Y \
        HEIGHT=$HEIGHT1   WIDTH=$WIDTH1 LANE_WIDTH=$LANE_WIDTH1 \
        DEGREES=$DEGREES1 CLOCK=$CLOCK1 CENTER_X=$CENTER_X1 \
        CENTER_Y=$CENTER_Y1 EXCHANGE_POS=$EXCHANGE1
...
nsplug meta_vehicle.bhv targ_$VNAME2.bhv -f VNAME=$VNAME2      \
    START_POS=$START_POS2 SURVEY_X=$SURVEY_X SURVEY_Y=$SURVEY_Y \
        ...
        DEGREES=$DEGREES2 CLOCK=$CLOCK2 CENTER_X=$CENTER_X2 \
        CENTER_Y=$CENTER_Y2 EXCHANGE_POS=$EXCHANGE2
